...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~bMAhyCYZ#ZwLy1xqhs1rXgxEyUv_rAvbuySIExbZRx6iLWZKIwG4",
    CAPTION: process.env.CAPTION || "POWERED By Baloch",
    ...
    OWNER_NAME: process.env.OWNER_NAME || "➺bike_ℓσѵε૨࿐",
    READ_CMD: process.env.READ_CMD || "true",
    BOT_NAME: process.env.BOT_NAME || "➺Baloch-SILENCE-MD",
